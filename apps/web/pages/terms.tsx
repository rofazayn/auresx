...
const Terms: NextPage = () => {
  return (
    <>
      <Head>
        <title>AuresX - Terms of Use</title>
        <meta name='description' content='Terms of Use by AuresX' />
      ...
      <Container size='md'>
        <Stack spacing={20}>
          ...
          <List size='sm' type='ordered'>
            ...
            <List.Item>
              <Anchor href='#sec-2'>INTELLECTUAL PROPERTY RIGHTS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-3'>USER REPRESENTATIONS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-4'>USER REGISTRATION</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-5'>PROHIBITED ACTIVITIES</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-6'>USER GENERATED CONTRIBUTIONS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-7'>CONTRIBUTION LICENSE</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-8'>GUIDELINES FOR REVIEWS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-9'>SOCIAL MEDIA</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-10'>SUBMISSIONS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-11'>THIRD-PARTY WEBSITE AND CONTENT</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-12'>ADVERTISERS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-13'>SITE MANAGEMENT</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-14'>PRIVACY POLICY</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-15'>COPYRIGHT INFRINGEMENTS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-16'>TERM AND TERMINATION</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-17'>MODIFICATIONS AND INTERRUPTIONS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-18'>GOVERNING LAW</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-19'>DISPUTE RESOLUTION</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-20'> CORRECTIONS</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-21'>DISCLAIMER</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-22'>LIMITATIONS OF LIABILITY</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-23'>INDEMNIFICATION</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-24'>USER DATA</Anchor>
            </List.Item>
            <List.Item>
              <Anchor href='#sec-25'>
            ...
            <List.Item>
              <Anchor href='#sec-26'>MISCELLANEOUS</Anchor>
            </List.Item>
            <List.Item>
          ...
          <Text size='sm'>
            ...
            Algeria and have our registered office at 5th of July St, Batna,
            Batna Province 05000. You agree that by accessing the Site, you have
          ...
          <Text size='sm'>As a user of the Site, you agree not to:</Text>
          ...
          <Text size='sm'>
            ...
            <Link href='/privacy-policy' passHref>
              <Anchor>https://auresx.com/privacy-policy</Anchor>
            </Link>
            ...
            Site is hosted in Germany. If you access the Site from any other
            region of the world with laws or other requirements governing
            personal data collection, use, or disclosure that differ from
            applicable laws in Germany, then through your continued use of the
            Site, you are transferring your data to Germany, and you agree to
            have your data transferred to and processed in Germany.{' '}
          </Text>
          ...
          <Text size='sm'>
            ...
            the Algeria courts. AuresX SPAS shall also maintain the right to
          ...
          <Text size='md'>
            ...
            <br />
            <b>Phone: (+213)549985283</b>
            <br />
            <b>E-mail: contact@auresx.com</b>
          </Text>
        </Stack>
      </Container>
    </>
