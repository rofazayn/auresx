    ...
    <Box>
      ...
      >
        <Box>
          ...
          <Text size='sm' color='dimmed' sx={{ maxWidth: 420 }}>
            Choose how AuresX looks to you. Select a single theme, or select the
            sync with your system option.
          </Text>
        </Box>
      </Box>
      ...
      >
        <Box>
          ...
          <Text size='sm' color='dimmed' sx={{ maxWidth: 420 }}>
            Change your default language and enjoy a better experience on all
            AuresX products and services.
          </Text>
        </Box>
      </Box>
      <Box>
        <Select
          ...
          description='Pick your language from the select box'
          size='md'
          sx={{ maxWidth: 380 }}
        />
      </Box>
